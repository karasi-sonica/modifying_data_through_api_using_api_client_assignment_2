...
const MenuItem = require('./model/menuItems');  // Corrected import for MenuItem
...
// Connect to MongoDB
mongoose.connect('mongodb+srv://karasisonica:APIclientdb@api-client.1whyn.mongodb.net/')
